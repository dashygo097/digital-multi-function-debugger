...
module axilite_master_uart_cmd_32x32_b115200_f100000000(
  ...
  wire        _GEN_8 = _uart_cmd_UART_CMD_cmd_valid & ~_uart_cmd_UART_CMD_cmd_type;
  wire        _GEN_9 = _GEN_0 & M_AXI_AWREADY & axi_awvalid;
  wire        _GEN_10 = _GEN_0 & M_AXI_WREADY & axi_wvalid;
    ...
    if (reset) begin
      ...
      if (_GEN) begin
        ...
        if (_GEN_0) begin
          ...
          state <= 3'h0;
        axi_bready <= _GEN_0 ? _GEN_7 | axi_bready : ~(_GEN_1 & _GEN_2) & axi_bready;
      end
      if (_GEN & _GEN_8) begin
        axi_awaddr <= _uart_cmd_UART_CMD_cmd_addr;
        axi_wdata <= _uart_cmd_UART_CMD_cmd_wdata;
      end
      axi_awvalid <= _GEN ? _GEN_8 | axi_awvalid : ~_GEN_9 & axi_awvalid;
      axi_wvalid <= _GEN ? _GEN_8 | axi_wvalid : ~_GEN_10 & axi_wvalid;
      ...
      axi_arvalid <=
        _GEN
          ...
          : (_GEN_12 | ~(_GEN_3 & _GEN_11)) & axi_arvalid;
      if (~(_GEN | _GEN_12))
        axi_rready <= _GEN_3 ? _GEN_11 | axi_rready : ~_GEN_6 & axi_rready;
      aw_done <= _GEN ? ~_GEN_8 & aw_done : _GEN_9 | aw_done;
      w_done <= _GEN ? ~_GEN_8 & w_done : _GEN_10 | w_done;
    end
  end // always @(posedge)
...
// ----- 8< ----- FILE "verification/layers-axilite_master_uart_cmd_32x32_b115200_f100000000-Verification.sv" ----- 8< -----

// Generated by CIRCT firtool-1.128.0
`ifndef layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification
  `define layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification
`endif // not def layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification

// ----- 8< ----- FILE "verification/assert/layers-axilite_master_uart_cmd_32x32_b115200_f100000000-Verification-Assert.sv" ----- 8< -----

// Generated by CIRCT firtool-1.128.0
`ifndef layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification_Assert
  `define layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification_Assert
  `include "layers-axilite_master_uart_cmd_32x32_b115200_f100000000-Verification.sv"
`endif // not def layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification_Assert

// ----- 8< ----- FILE "verification/assume/layers-axilite_master_uart_cmd_32x32_b115200_f100000000-Verification-Assume.sv" ----- 8< -----

// Generated by CIRCT firtool-1.128.0
`ifndef layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification_Assume
  `define layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification_Assume
  `include "layers-axilite_master_uart_cmd_32x32_b115200_f100000000-Verification.sv"
`endif // not def layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification_Assume

// ----- 8< ----- FILE "verification/cover/layers-axilite_master_uart_cmd_32x32_b115200_f100000000-Verification-Cover.sv" ----- 8< -----

// Generated by CIRCT firtool-1.128.0
`ifndef layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification_Cover
  `define layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification_Cover
  `include "layers-axilite_master_uart_cmd_32x32_b115200_f100000000-Verification.sv"
`endif // not def layers_axilite_master_uart_cmd_32x32_b115200_f100000000_Verification_Cover
